...
int main()
{
    ...
    int empID;  // Result of the search
...
// The first parameter holds the subscript of the
// starting element, and the last holds the subscript of the
// array's last element. The parameter value holds the
// search value. If the search value is found, its
